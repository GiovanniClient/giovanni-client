                                    ...
                                    @Nullable ScreenRect bounds) implements SimpleGuiElementRenderState
{
	...
	{
		this(RenderPipelines.GUI, TextureSetup.empty(), pose, x1, y1, x2,
    ...
    public void setupVertices(VertexConsumer vertices) {
        System.out.println("you implemented this code because of ide complains but didnt write anything");
