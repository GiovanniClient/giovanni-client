...
public class AboutConfig extends Config {
    ...
    public static class UsedSoftware {
        ...
        public Runnable moulconfig = () -> Util.getOperatingSystem().open("https://github.com/NotEnoughUpdates/MoulConfig");

        @ConfigOption(name = "Fabric (Apache 2.0)", desc = "")
        @ConfigEditorButton(buttonText = "Source")
        public Runnable fabric = () -> Util.getOperatingSystem().open("https://github.com/FabricMC/fabric");

        @ConfigOption(name = "Mixin (MIT)", desc = "")
        @ConfigEditorButton(buttonText = "Source")
        public Runnable mixin = () -> Util.getOperatingSystem().open("https://github.com/SpongePowered/Mixin/");

        @ConfigOption(name = "LibAutoUpdate (BSD-2-Clause)", desc = "")
        @ConfigEditorButton(buttonText = "Source")
        public Runnable libautoupdate = () -> Util.getOperatingSystem().open("https://github.com/nea89o/libautoupdate");

        @ConfigOption(name = "WI-Freecam (GPL 3.0)", desc = "rewritten with yarn mappings")
        @ConfigEditorButton(buttonText = "Source")
        public Runnable wi_freecam = () -> Util.getOperatingSystem().open("https://github.com/Wurst-Imperium/WI-Freecam");
        ...
        @ConfigEditorButton(buttonText = "Source")
        public Runnable skyhanni = () -> Util.getOperatingSystem().open("https://github.com/hannibal002/SkyHanni/");
    }
