...
public class SlayersConfig {
    ...
    public static class EndermanAccordion {
        ...
        public static class AutoSoulcry {
            @Expose
            @ConfigOption(name = "Main Toggle", desc = "Automatically uses the slayer's katana's Soulcry ability during boss fights")
            @ConfigEditorBoolean
            ...
            @ConfigEditorSlider(minValue = 0, maxValue = 5000, minStep = 100)
            public int ADDITIONAL_DELAY = 500;
